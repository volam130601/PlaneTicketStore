...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand--> 
            <a class="navbar-brand ps-3" href="<c:url value="/admin/home"></c:url>">ADMIN</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <li class="nav-item"><a class="nav-link" aria-current="page" href="<c:url value="/web/home"/>">Website Plane Ticket</a></li>
